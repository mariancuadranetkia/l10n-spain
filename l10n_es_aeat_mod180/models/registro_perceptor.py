...
class RegistroPerceptor(models.Model):
    ...
    informacion_catastral_id = fields.Many2one(
        "informacion.catastral", string="Información catastral"
    )
    ...
    cuota_retenciones = fields.Float(
    ...
    cuota_move_line_ids = fields.Many2many(
        "account.move.line",
        "reg_perceptor_cuota_move_line_rel",
        "reg_perceptor_id",
        "move_line_id",
        string="Apuntes contable de cuota",
    )
